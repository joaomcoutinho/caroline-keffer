...
export function BotaoFlutuante() {
  return (
    <a
      ...
      className="botao-flutuante fixed right-5 z-50 hidden h-14 w-14 items-center justify-center rounded-full text-white shadow-[0_10px_30px_-8px_rgba(0,0,0,0.45)] transition-transform duration-200 ease-[var(--ease-soft)] hover:scale-105 [@media(hover:hover)]:active:scale-95 sm:right-7 sm:flex sm:h-16 sm:w-16"
