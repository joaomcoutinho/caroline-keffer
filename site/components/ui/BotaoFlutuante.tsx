 ...
 *
 * Este é o ÚNICO ponto do site que usa o verde do WhatsApp (#25D366) em vez do
 * ciano da marca. É exceção deliberada: aqui o verde não é decoração, é
 * sinalização — o usuário reconhece o botão antes de ler qualquer coisa. Fora
 * daqui, toda ação continua ciano.
 *
...
export function BotaoFlutuante() {
  return (
    ...
    >
      {/* Logo oficial do WhatsApp. Marca de terceiro, então não é recolorida. */}
      <svg
        viewBox="0 0 24 24"
        width="30"
        height="30"
